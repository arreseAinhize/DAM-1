...
public class Erabiltzailea {
    ...
    public Erabiltzailea(String kontua, String izena, String abizena, int adina, String pasahitza) {
        this.kontua = kontua;
        this.izena = izena;
     ...
     * Adibidez, 'iurkidi'
     */
    public Erabiltzailea(String izena, String abizena, int adina) {
       this.izena = izena;
       this.abizena = abizena;
       this.adina = adina;
    }
    ...
    public String toString() {
        return kontua + ", " + izena + ", " + abizena + ", " + adina + ", " + pasahitza;
    }
