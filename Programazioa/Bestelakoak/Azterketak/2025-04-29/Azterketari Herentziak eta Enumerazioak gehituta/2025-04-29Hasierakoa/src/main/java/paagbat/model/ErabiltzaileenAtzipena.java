...
public class ErabiltzaileenAtzipena {
    ...
    public int txertatu(Erabiltzailea erabiltzailea) {
        ...
        String sql = "INSERT INTO " + taula + " VALUES ('" + erabiltzailea.getKontua() + "', '" + erabiltzailea.getIzena() + "', '" + erabiltzailea.getAbizena() + "', '" + erabiltzailea.getAdina() + "', '" + erabiltzailea.getRola().name() + "', '"+ erabiltzailea.getPasahitza() +"')";
        try {
    ...
    public List<Erabiltzailea> getErabiltzaileak() {
        ...
        try {
            ...
            while (result.next()) { // Next bakoitza hurrengo lerroa
                ...
                String abizena = result.getString("abizena");
                int adina = result.getInt("adina");
                ErabiltzaileMota rola = ErabiltzaileMota.valueOf(result.getString("rola").toUpperCase());
                String pasahitza = result.getString("pasahitza");

                if(rola.equals("ikaslea")) {
                    erabiltzaileList.add(new Ikasleak(kontua, izena, abizena, adina, pasahitza, rola)); // Lerro bakoitza erabiltzailea objektua
                } else if(rola.equals("irakaslea")) {
                    erabiltzaileList.add(new Irakasleak(kontua, izena, abizena, adina, pasahitza, rola)); // Lerro bakoitza erabiltzailea objektua
                } else {
                    erabiltzaileList.add(new Erabiltzailea(kontua, izena, abizena, adina, pasahitza)); // Lerro bakoitza erabiltzailea objektua
                }
            }
    ...
    public List<Erabiltzailea> getRolBatekoErabiltzaileak(String rola) {
        ...
        try {
            ...
            while (result.next()) { // Next bakoitza hurrengo lerroa
                ...
                String abizena = result.getString("abizena");
                int adina = result.getInt("adina");
                ErabiltzaileMota rol = ErabiltzaileMota.valueOf(result.getString("rola").toUpperCase());
                String pasahitza = result.getString("pasahitza");

                if(rol.equals("ikaslea")) {
                    erabiltzaileList.add(new Ikasleak(kontua, izena, abizena, adina, pasahitza, rol)); // Lerro bakoitza erabiltzailea objektua
                } else if(rol.equals("irakaslea")) {
                    erabiltzaileList.add(new Irakasleak(kontua, izena, abizena, adina, pasahitza, rol)); // Lerro bakoitza erabiltzailea objektua
                } else {
                    erabiltzaileList.add(new Erabiltzailea(kontua, izena, abizena, adina, pasahitza)); // Lerro bakoitza erabiltzailea objektua
                }
            }
